...
- The Microcontroller is an STM32F4 microcontroller running FreeRTOS. It allows all hardware to be controlled via the control cluster, or sensors, on the handlebar of the bike.
...
- Hardware includes headlights, tail lights, car horn, NFC scanner and keycard unlock, cool LED lights, human detection alarm, and more!
